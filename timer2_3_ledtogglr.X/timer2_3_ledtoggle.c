/*
 * File:   timer2_3_ledtoggle.c
 * Author: tushar.mali
 *
 * Created on 28 January, 2023, 2:02 PM
 */


/*
 * File:   uart_main.c
 * Author: The_PPP_Engineer
 *
 * Created on 12 January, 2023, 1:26 PM
 */
...
void Timer23_Init (void)
{
    ...
    T2CONbits.TGATE = 0;        //no TGATE Operations
    T2CONbits.TCS = 0;          //internal CLK 
    T2CONbits.TECS = 0x00;

    T2CONbits.TCKPS = 3;        //1:256 pre-scale
    /*
      PRESCALE = 256
